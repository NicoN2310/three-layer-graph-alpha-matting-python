...
def calculate_matte(image, trimap,
                    K0=12, K1=12, K2=7, K3=3, ratio_1=0.418746, ratio_2=0.154445,  # getThreeGraph
                    epsilon=1e-7, win_size=1,  # get_color_line_laplace
                    delta=7, lambda_val=1000, tol=1e-7, maxit=2000):
    ...
    Alpha, _ = sparse.linalg.bicgstab(L + Lambda, 
                                      Lambda.dot(G), 
                                      x0=initial_guess, 
                                      rtol=tol, 
                                      maxiter=maxit)
